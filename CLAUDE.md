...
This project is indexed by GitNexus as **kiwi** (7390 symbols, 21217 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
