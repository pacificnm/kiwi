...
- [ ] Fuzzy file find returns expected paths
- [ ] Content search finds string in repo
- [ ] Debounce prevents search storm while typing
- [ ] Selection opens correct file/line
- [ ] Ignore dirs excluded from file search
