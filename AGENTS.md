...
This project is indexed by GitNexus as **kiwi** (8674 symbols, 20846 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
