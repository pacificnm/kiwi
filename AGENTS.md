...
This project is indexed by GitNexus as **kiwi** (8317 symbols, 20093 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
