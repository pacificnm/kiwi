...
This project is indexed by GitNexus as **kiwi** (6462 symbols, 15700 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
